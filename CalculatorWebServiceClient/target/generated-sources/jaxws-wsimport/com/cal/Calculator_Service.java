 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://cal.com/", wsdlLocation = "http://localhost:8080/CalculatorWebService/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://cal.com/", "Calculator");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://cal.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cal.com/", "CalculatorPort"), Calculator.class, features);
    }
